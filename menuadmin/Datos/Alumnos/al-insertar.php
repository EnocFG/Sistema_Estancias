      ...
      <nav class="navbar bg-dark navbar-dark">
        <div class="d-flex align-items-center ms-4 mb-4">
          <div class="position-relative">
            ...
            <div
              class="bg-success rounded-circle border-light border-2 border-white position-absolute end-0 bottom-0 p-1">
            </div>
          </div>
          <div class="ms-3">
        ...
        <div class="navbar-nav w-100">
          ...
          <a href="../../dashboard-admin.php" class="nav-item nav-link"><i
              class="fa fa-tachometer-alt me-2"></i>Dashboard</a>

          <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                class="fa fa-user me-2"></i>Alumnos</a>
          ...
          <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                class="fa fa-user-check me-2"></i>Asesores</a>
            <div class="dropdown-menu bg-light border-0">
          ...
          <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                class="fa fa-briefcase me-2"></i>Empresas</a>
            <div class="dropdown-menu bg-light border-0">
  ...
  <div class="content">
    ...
    <body>
      ...
      <form action="../Alumnos/validations/validar_insertar.php" method="POST">
        ...
        <input type="text" id="Matricula" name="Matricula" placeholder="matricula" class="input"
        ...
        <input type="email" id="Correo_electronico" name="Correo_electronico" placeholder="&#64 correo electronico"
          class="input" required><br>
        <input type="text" id="id_grupo_fk" name="id_grupo_fk" placeholder="id_grupo" class="input" required><br>
        <input type="text" id="id_cuatrimestre_fk" name="id_cuatrimestre_fk" placeholder="id_cuatrimestre" class="input"
          required><br>
